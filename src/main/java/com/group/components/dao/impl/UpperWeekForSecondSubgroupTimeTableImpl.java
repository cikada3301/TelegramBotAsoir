...
@Getter
@AllArgsConstructor
public class UpperWeekForSecondSubgroupTimeTableImpl implements TimeTablesDao {
    ...
    public void setTimeTables() {
        timeTables.add(new TimeTable("понедельник", Arrays.asList("-", "-", "ООП 517 ауд.корпус 2", "-", "-")));
        timeTables.add(new TimeTable("вторник", Arrays.asList("Культурология 308 ауд. корпус 1", "ОАУ 406 ауд. корпус 7", "МО ауд. 229 корпус 1")));
        ...
        timeTables.add(new TimeTable("пятница", Arrays.asList("-", "МО 111 ауд. корпус 2", "-")));
    }
}
